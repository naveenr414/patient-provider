...
do 
    ...
    do 
        python -u all_policies_small.py --seed ${seed} --n_patients 1225 --n_providers 700 --provider_capacity 1 --noise 0.25 --num_trials 25 --utility_function semi_synthetic_comorbidity --order uniform --out_folder ablations --num_samples ${num_samples}
    done 
