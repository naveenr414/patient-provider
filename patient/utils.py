...
def solve_linear_program_online(weights,capacities):
    ...
    _, M_plus_1 = weights.shape 
    M = M_plus_1 - 1

    # Add random future weights
    N = 10
    random_rows = np.random.rand(N-1, M_plus_1)
    # Stack them vertically
    weights = np.vstack([weights, random_rows])
